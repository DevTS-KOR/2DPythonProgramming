...
def enter():
    ...
    if hurdle_start == None:
        for i in range(len_data3_1['Stage3_Spear']['Len']):
            hurdle.append(Hurdle_third(len_data3_1['Stage3_Spear']['num'], i))
        for i in range(len_data3_1['Stage3_Spear2']['Len']):
            hurdle.append(Hurdle_third(len_data3_1['Stage3_Spear2']['num'], i))
        for i in range(len_data3_1['Stage3_thorn3']['Len']):
            hurdle.append(Hurdle_third(len_data3_1['Stage3_thorn3']['num'], i))
        for i in range(len_data3_1['big_jelly']['Len']):
            hurdle.append(Hurdle_third(len_data3_1['big_jelly']['num'], i))
        for i in range(len_data3_1['item_jelly']['Len']):
            hurdle.append(Hurdle_third(len_data3_1['item_jelly']['num'], i))

##############################################################################

        for i in range(len_data3_2['Stage3_Spear']['Len']):
            hurdle.append(Hurdle_third2(len_data3_2['Stage3_Spear']['num'], i))
        for i in range(len_data3_2['Stage3_thorn3']['Len']):
...
################################################################################
        ...
        for i in range(len_data3_3['Stage3_Spear']['Len']):
            hurdle.append(Hurdle_third3(len_data3_3['Stage3_Spear']['num'], i))
        for i in range(len_data3_3['Stage3_Spear2']['Len']):
            hurdle.append(Hurdle_third3(len_data3_3['Stage3_Spear2']['num'], i))
        for i in range(len_data3_3['Stage3_thorn']['Len']):
            hurdle.append(Hurdle_third3(len_data3_3['Stage3_thorn']['num'], i))
        for i in range(len_data3_3['Stage3_thorn5']['Len']):
            hurdle.append(Hurdle_third3(len_data3_3['Stage3_thorn5']['num'], i))
        for i in range(len_data3_3['hp_jelly']['Len']):
...
################################################################################
        ...
        for i in range(len_data3_4['Stage3_Spear']['Len']):
            hurdle.append(Hurdle_third4(len_data3_4['Stage3_Spear']['num'], i))
        for i in range(len_data3_4['Stage3_Spear2']['Len']):
            hurdle.append(Hurdle_third4(len_data3_4['Stage3_Spear2']['num'], i))
        for i in range(len_data3_4['Stage3_thorn3']['Len']):
            hurdle.append(Hurdle_third4(len_data3_4['Stage3_thorn3']['num'], i))
        for i in range(len_data3_4['Stage3_thorn4']['Len']):
            hurdle.append(Hurdle_third4(len_data3_4['Stage3_thorn4']['num'], i))
        for i in range(len_data3_4['item_jelly']['Len']):
            hurdle.append(Hurdle_third4(len_data3_4['item_jelly']['num'], i))

##################################################################################

        for i in range(len_data3_5['Stage3_Spear']['Len']):
            hurdle.append(Hurdle_third5(len_data3_5['Stage3_Spear']['num'], i))
        for i in range(len_data3_5['Stage3_thorn']['Len']):
            hurdle.append(Hurdle_third5(len_data3_5['Stage3_thorn']['num'], i))
        for i in range(len_data3_5['Stage3_thorn5']['Len']):
            hurdle.append(Hurdle_third5(len_data3_5['Stage3_thorn5']['num'], i))
        for i in range(len_data3_5['hp_jelly']['Len']):
    ...
    if player.hpsize < 500:
        for i in hurdle:
            ...
            if collide(player, i) and player.big == False:
                if i.arr['dir'] == 'Image\\big_jelly3.png':
                    gaint_sound.play()
                    ...
                    #print(frame_time)
                elif i.arr['dir'] == 'Image\\item_jelly3.png':
                    jelly_sound.play()
                    converter.player_money += 1
                    hurdle.remove(i)
                elif i.arr['dir'] == 'Image\\hp_jelly3.png':
                    hp_sound.play()
