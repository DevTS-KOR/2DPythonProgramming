...
class Background_third:
    ...
    def __init__(self):
        ...
        if Background.Image_init == None:
            self.background_first = load_image('Image\\Third_Background.png')
            self.background_second = load_image('Image\\Third_Background.png')
            self.background_rotate = load_image('Image\\Rotate\\Third_Background_Rotate.png')
...
class Background_four:
    ...
    def __init__(self):
        ...
        self.sum_second_distance = 0.0
        if Background_second.Image_init == None:
            self.background_first = load_image('Image\\Fourth_Background.png')
            self.background_second = load_image('Image\\Fourth_Background.png')
            self.background_rotate = load_image('Image\\Rotate\\Four_Background_Rotate.png')
