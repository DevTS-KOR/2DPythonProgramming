...
class Ground_third:
    ...
    def __init__(self):
        ...
        self.sum = 0
        if Ground.Image_init == None:
            self.ground_first = load_image('Image\\Third_ground.png')
            self.ground_second = load_image('Image\\Third_ground.png')
...
class Ground_four:
    ...
    def __init__(self):
        ...
        self.frame = 0
        if Ground_second.Image_init == None:
            self.ground_first = load_image('Image\\Fourth_ground.png')
            self.ground_second = load_image('Image\\Fourth_ground.png')
